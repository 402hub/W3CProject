    ...
    <div className="app">
      <header className="app-header">
        <div className="header-left">
          ...
          <span className="version-badge">v4.2 Bug Fixes</span>
        </div>
        ...
        {!isConnected ? (
          <div className="welcome-screen">
            <div className="welcome-content">
              <h2>Welcome to Telegram Killer v4.2</h2>
              <p className="subtitle">🔒 Critical Security Fixes</p>
              <div className="features-list">
                <div className="feature">🔒 Wallet-isolated conversations (privacy fix)</div>
                <div className="feature">📱 Multiple wallet options (mobile support)</div>
                <div className="feature">✅ WalletConnect integration</div>
                <div className="feature">✅ Coinbase Wallet support</div>
                <div className="feature">✅ Proper wallet switching</div>
              </div>
              <p className="description">
                Fast, secure messaging with wallet-based authentication.
                Now with mobile wallet support and proper privacy isolation!
              </p>
              <WalletConnect />
            </div>
          </div>

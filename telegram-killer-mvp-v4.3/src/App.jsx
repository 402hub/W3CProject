    ...
    <div className="app">
      <header className="app-header">
        <div className="header-left">
          ...
          <span className="version-badge">v4.3 P2P Sync</span>
        </div>
        ...
        {!isConnected ? (
          <div className="welcome-screen">
            <div className="welcome-content">
              <h2>Welcome to Telegram Killer v4.3</h2>
              <p className="subtitle">🚀 Real P2P Messaging!</p>
              <div className="features-list">
                <div className="feature">🔥 Real-time P2P message delivery</div>
                <div className="feature">📱 Multi-device sync with Firebase</div>
              ...
              <p className="description">
                ...
                Messages sync in real-time between all users via Firebase!
              </p>
              <WalletConnect />
            </div>
          </div>
